...
SSHManager::SSHManager(const std::string &hostName, const std::string &userName, const std::string &password, int port)
...
bool SSHManager::connect()
{
    ...
    qDebug() << "SSH connection established on port" << port << ".";
    return true;
}
